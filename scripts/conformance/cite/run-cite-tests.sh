...
# Configuration
CITE_COMPOSE_FILE="docker/cite/ogc-api-features/compose.yml"
...
docker cp docker/cite/ogc-api-features/seed.sql "$POSTGRES_CONTAINER":/tmp/cite-seed.sql
...
if [[ "$PROFILE" != "default" ]]; then
    ...
    sed -i "s/<parsers:profile>.*<\/parsers:profile>/<parsers:profile>$PROFILE<\/parsers:profile>/" docker/cite/ogc-api-features/config/test-params.xml
fi
