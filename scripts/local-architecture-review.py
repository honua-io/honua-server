#!/usr/bin/env python3
"""
Local Architecture Review for Honua Server
...
def get_honua_rules() -> str:
    """Get Honua-specific architecture rules from AGENTS.md"""
    try:
        ...
        if agents_md_path.exists():
            ...
            if match:
                ...
                return f"# Architecture Rules from AGENTS.md\n\n{rules_section}"

        # Fallback if AGENTS.md not found or section not found
...
"""
        ...
        return f"# Architecture Rules (Error reading AGENTS.md: {e})\n\nFallback to basic checks..."
...
def local_architecture_review() -> Dict[str, Any]:
    ...
    print("🔍 Running Local Architecture Review...")
...
def print_review_results(results: Dict[str, Any]):
    ...
    print("\n" + "="*60)
    print("🏗️  LOCAL ARCHITECTURE REVIEW RESULTS")
    print("="*60)
