...
usage() {
    cat <<'EOF'
Usage: ./scripts/cloud/run-cloud-post-apply-validation.sh [--terraform-output-json <path>] [--include-scale-tests]
...
chmod +x scripts/cloud/post-deployment-verification.sh
