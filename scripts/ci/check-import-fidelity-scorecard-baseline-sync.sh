...
parity_test_file="${1:-tests/dotnet/Honua.Server.Tests/Import/GeoservicesImportFidelityIntegrationTests.cs}"
baseline_scorecard="${2:-tests/dotnet/Honua.Server.Tests/Import/import-fidelity-scorecard-baseline.json}"
