...
def build_architecture_review_prompts(context: str, is_test: bool) -> tuple[str, str]:
    """Build provider-neutral architecture review prompts."""
...
def analyze_with_openai(context: str, api_key: str, is_test: bool) -> str:
    ...
    try:
        ...
        system_prompt, user_prompt = build_architecture_review_prompts(context, is_test)
...
def analyze_with_anthropic(context: str, api_key: str, is_test: bool) -> str:
    """Analyze using Anthropic Messages API."""
    system_prompt, user_prompt = build_architecture_review_prompts(context, is_test)
...
**⚠️ Anthropic Analysis Error:**
Anthropic returned no text content.

**Overall Assessment:** NEEDS_ATTENTION (API Response Issue)"""
