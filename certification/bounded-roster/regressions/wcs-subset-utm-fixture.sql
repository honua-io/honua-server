...
VALUES ('coverage_4997_utm', 'Coverage client regression', 32610, ARRAY['JSON'], ARRAY['Query'],
        ST_Transform(ST_MakeEnvelope(587850,4095400,587950,4095500,32610),4326), '{"accessPolicy":{"allowAnonymous":true}}');
INSERT INTO honua.layers (layer_id, layer_name, description, table_name, geometry_type, srid, extent, metadata)
VALUES (2497, 'Coverage 4997 UTM', 'Independent four by four gradient', 'features', 'Polygon', 32610,
        ST_Transform(ST_MakeEnvelope(587850,4095400,587950,4095500,32610),4326), '{"accessPolicy":{"allowAnonymous":true}}');
INSERT INTO honua.service_layers (service_name, layer_id, layer_order) VALUES ('coverage_4997_utm',2497,0);
INSERT INTO honua.raster_data (layer_id, name, description, raster)
VALUES (2497, 'gradient-with-nodata', 'value=10*row+col, nodata at row=1 col=2',
        ST_MapAlgebra(
            ST_AddBand(ST_MakeEmptyRaster(4,4,587850,4095500,25,-25,0,0,32610), '32BF'::text, 0, -9999),
