    ...
    : AnalysisProfileToolBase(jobs, logger)
{
    ...
    protected override string Description => "Buffer a published layer or prior analysis artifact through the canonical geoprocessing job service.";
    ...
    : AnalysisProfileToolBase(jobs, logger)
{
    ...
    protected override string Description => "Run a two-dataset topological overlay as a canonical geoprocessing job.";
    ...
    : AnalysisProfileToolBase(jobs, logger)
{
    ...
    protected override string Description => "Compute grouped summary statistics as a canonical geoprocessing job.";
    ...
    : AnalysisProfileToolBase(jobs, logger)
{
    ...
    protected override string Description => "Reproject a dataset through the canonical feature-project or managed transform process.";
    ...
    : AnalysisProfileToolBase(jobs, logger)
{
    ...
    protected override string Description => "Run an attribute or spatial join as a canonical geoprocessing job.";
    ...
    : AnalysisProfileToolBase(jobs, logger)
{
    ...
    protected override string Description => "Materialize a layer or analysis artifact into a downloadable output through the canonical job service.";
    ...
    protected override AnalysisPlan BuildPlan(JsonElement argument)
    {
        ...
        var inputs = new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["format"] = RequireString(argument, "format")
        };
        CopyScalar(argument, "where", inputs);
