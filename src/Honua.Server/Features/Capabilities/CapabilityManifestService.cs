        ...
        OperationCapabilitySummary operationCapabilities)
    {
        ...
        [
            ...
            Capability("serve.geoservices-imageserver", "raster", context,
                maturity: CapabilityMaturity.Preview,
                configured: options.ExperimentalCapabilityFlags.IsExperimentalEnabled("serve.geoservices-imageserver")),
            Capability("serve.wmts", "raster", context,
                maturity: CapabilityMaturity.Preview,
                configured: options.ExperimentalCapabilityFlags.IsExperimentalEnabled("serve.wmts")),
