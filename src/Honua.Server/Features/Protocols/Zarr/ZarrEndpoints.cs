...
internal static class ZarrEndpoints
{
    ...
    internal static Task<IResult> HandleDatacubeTile(
        HttpContext context,
        int layerId,
        ...
        int x,
        int y,
        [FromServices] ZarrDatacubeTileService tileService,
        CancellationToken cancellationToken)
        => tileService.HandleAsync(context, layerId, tileMatrixSetId, z, x, y, cancellationToken);
