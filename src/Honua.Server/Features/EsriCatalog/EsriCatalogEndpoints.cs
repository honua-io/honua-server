...
namespace Honua.Server.Features.EsriCatalog;

/// <summary>
/// GeoServices catalog endpoints for service discovery.
/// </summary>
internal static class EsriCatalogEndpoints
{
    ...
    /// </summary>
    public static IEndpointRouteBuilder MapEsriCatalogEndpoints(this IEndpointRouteBuilder endpoints)
    {
    ...
    private static async Task<IResult> HandleGetServicesDirectory(
        ...
        [FromServices] ILogger<EsriCatalogLog> logger)
    {
        ...
        foreach (var service in services.OrderBy(static s => s.Name, StringComparer.OrdinalIgnoreCase))
        {
            ...
            {
                EsriCatalogEndpointLogging.LogRasterProbeFailed(logger, service.Name, ex);
            }
        }
        ...
        EsriCatalogEndpointLogging.LogServicesDirectoryReturned(logger, response.Services.Length);

        return Results.Json(response, EsriCatalogJsonContext.Default.ServicesDirectoryResponse, contentType: JsonContentType);
    }
    ...
    private static IResult HandleGetRestInfo(HttpContext context, string? f)
    {
        ...
        return Results.Json(response, EsriCatalogJsonContext.Default.RestInfoResponse, contentType: JsonContentType);
    }
...
internal static partial class EsriCatalogEndpointLogging
{
...
/// </summary>
internal sealed class EsriCatalogLog
{
}
