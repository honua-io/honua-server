    ...
    [
        ...
        new ProcessDefinition
        {
            ...
            [
                ...
                Param("algorithm", "Algorithm", "Clustering algorithm: DbScan or KMeans.", ProcessParameterValueType.Text, required: true),
                Param("eps", "Epsilon", "Maximum distance between neighbors for DBSCAN (meters).", ProcessParameterValueType.FloatingPoint, defaultValue: "1000"),
                Param("minPoints", "Min Points", "Minimum cluster size for DBSCAN.", ProcessParameterValueType.WholeNumber, defaultValue: "5"),
                Param("k", "K", "Number of clusters for KMeans.", ProcessParameterValueType.WholeNumber),
        ...
        new ProcessDefinition
        {
            ...
            [
                ...
                Param("predicate", "Predicate", "Spatial predicate: Intersects, Contains, Within, or DWithin.", ProcessParameterValueType.Text, required: true),
                Param("distanceMeters", "Distance", "Distance threshold for DWithin predicate (meters).", ProcessParameterValueType.FloatingPoint),
            ],
            OutputArtifactKinds = [ArtifactKind.FeatureLayer, ArtifactKind.Table]
        },
        new ProcessDefinition
        {
            ...
            [
                ...
                Param("dissolve", "Dissolve", "Dissolve overlapping buffers.", ProcessParameterValueType.Flag, defaultValue: "false"),
            ],
            OutputArtifactKinds = [ArtifactKind.FeatureLayer]
        },
        new ProcessDefinition
        {
            ...
            [
                Param("layerId", "Layer", "Target layer identifier.", ProcessParameterValueType.LayerId, required: true),
                Param("mode", "Bin Mode", "Binning mode: HexGrid or SquareGrid.", ProcessParameterValueType.Text, required: true),
                Param("cellSizeMeters", "Cell Size", "Grid cell size in meters.", ProcessParameterValueType.FloatingPoint, required: true),
