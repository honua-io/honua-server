...
namespace Honua.Server.Features.CloudCog.Models;

/// <summary>
/// Request to register a cloud-hosted COG for direct serving.
/// </summary>
internal sealed record RegisterCloudCogRequest
{
    /// <summary>
...
/// <summary>
/// Response for a cloud COG registration.
/// </summary>
internal sealed record CloudCogRegistrationResponse
{
    /// <summary>
