...
public static class RedisConfigurationExample
{
    ...
    private static void ReplaceExistingRedisServices(IServiceCollection services)
    {
        ...
        var oldReplicaStore = services.FirstOrDefault(d =>
            d.ServiceType == typeof(Honua.Protocols.GeoServices.FeatureServer.DistributedReplicaStore));
        ...
        services.AddSingleton<Honua.Protocols.GeoServices.FeatureServer.StandardizedDistributedReplicaStore>(sp =>
            new Honua.Protocols.GeoServices.FeatureServer.StandardizedDistributedReplicaStore(
                sp.GetService<IDistributedCache>(),
                sp.GetService<IConnectionMultiplexer>(),
                sp.GetRequiredService<IRedisHealthMonitor>(),
                sp.GetRequiredService<IHostEnvironment>(),
                sp.GetRequiredService<ILogger<Honua.Protocols.GeoServices.FeatureServer.StandardizedDistributedReplicaStore>>()));
