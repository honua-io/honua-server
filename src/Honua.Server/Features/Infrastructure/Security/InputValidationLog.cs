...
{
    [LoggerMessage(Level = LogLevel.Warning, Message = "Input validation rejected request: {Error}")]
    public static partial void InputRejected(ILogger logger, string? error);
