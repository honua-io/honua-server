...
/// <summary>
/// Shared coordination health surface for Redis-backed job processors.
/// </summary>
internal interface IImportCoordinationHealth
{
    bool CanAcceptNewJobs { get; }
}

/// <summary>
/// Shared environment policy for Redis-backed job coordination.
/// </summary>
internal static class DistributedCoordinationMode
{
    public static bool RequiresStrictDistributedMode(IHostEnvironment hostEnvironment)
    {
