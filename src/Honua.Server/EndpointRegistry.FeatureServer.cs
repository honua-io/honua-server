...
public static partial class EndpointRegistry
{
    ...
    [
        ...
        new("POST", "/rest/services/{serviceId}/VersionManagementServer/versionInfos"),
        new("POST", "/rest/services/{serviceId}/VersionManagementServer/versions/{versionGuid}/adoptService"),
