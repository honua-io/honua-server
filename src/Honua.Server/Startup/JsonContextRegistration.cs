...
internal static class JsonContextRegistration
{
    public static IServiceCollection AddHonuaJsonContexts(this IServiceCollection services)
    {
        ...
        Honua.Server.Features.Protocols.Rasters.CogArtifacts.CogArtifactJsonContext.Default,
        ...
        Honua.Server.Features.Studio.Ai.StudioAiProxyEndpointsJsonContext.Default,
