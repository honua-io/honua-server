...
#pragma warning restore CA1873
    ...
    /// supports under Routing, and the dedicated synchronous NetworkAnalysisUtilities
    /// GP service carrying GetTravelModes/GetToolInfo.
    ...
    private static async Task<PortalHelperServices?> BuildHelperServicesAsync(HttpContext context)
    {
        ...
        if (await GPServer.GPServerEndpoints.ValidateNetworkAnalysisUtilityServiceAsync(context, context.RequestAborted).ConfigureAwait(false) is not null)
        {
            return null;
        }
        ...
        var utilities = $"{baseUrl}/rest/services/{NAServer.NAServerMetadata.UtilityServiceId}/GPServer";
        ...
        return new PortalHelperServices
        {
            ...
            RoutingUtilities = new PortalHelperService { Url = utilities },
        };
    }
