...
internal static class GeoServicesGeometryParser
{
        ...
        out string? error)
    {
        ...
        // An envelope needs all four ordinates. Without this count guard, the envelope
        // branch fired for esriGeometryEnvelope *regardless of how many coordinates parsed*,
        // so a short list (e.g. "1,2") read xmax/ymax from the zero-initialized stackalloc
        // tail and silently queried a different window instead of returning 400 (#1990).
        // Require exactly four coordinates for the envelope.
