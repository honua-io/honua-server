...
{
    /// <summary>The NetworkAnalysisUtilities tasks published by the synchronous utility service.</summary>
    ...
    /// <summary>Dedicated synchronous routing utility service; never a process-job catalog.</summary>
    public const string UtilityServiceId = "NetworkAnalysisUtilities";
