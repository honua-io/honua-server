...
internal sealed class PostgresMetadataV2GraphStore : IMetadataV2GraphStore, IMetadataV2GraphWriteBaseReader
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        catch (FeatureEditCommitOutcomeUnknownException)
        {
            ...
            // this exact xid durable before the acknowledgement was lost, returning the receipt lets
            // the caller either commit its paired catalog transaction or compensate this graph write.
            // Throwing here would leave the caller with no mutation identity and an orphan graph.
