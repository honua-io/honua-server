        ...
        List<MetadataCompatibilityFinding> findings)
    {
        ...
        if (sourceField.Type != targetField.Type)
        {
            findings.Add(Finding(
                ...
                Value("fieldType", sourceField.Type.ToJsonName(), expectedDetails),
                Value("fieldType", targetField.Type.ToJsonName(), FieldDetails(targetResource, targetField)),
        ...
        if (expectedGeometryType != MetadataV2GeometryType.None)
        {
            ...
            if (actualGeometryType == MetadataV2GeometryType.None)
            {
                findings.Add(Finding(
                    ...
                    Value("geometryType", expectedGeometryType.ToJsonName()),
            ...
            else if (expectedGeometryType != actualGeometryType)
            {
                findings.Add(Finding(
                    ...
                    Value("geometryType", expectedGeometryType.ToJsonName()),
                    Value("geometryType", actualGeometryType.ToJsonName()),
                    MetadataCompatibilityRequiredAction.UpdateSpatial,
                    MetadataCompatibilityCoverageState.Uncovered));
            }
        }
