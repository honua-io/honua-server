...
/// <param name="Domain">Optional value domain (coded-value or range) for the field.</param>
/// <param name="Hidden">Whether public protocol output should omit the field.</param>
/// <param name="DefaultValue">Optional per-field default value applied by edit-capable services on insert.</param>
...
/// <param name="DefaultValue">Optional per-field default value update. Null preserves the current value.</param>
