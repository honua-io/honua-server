...
public sealed class QueryProcessor : IQueryProcessor
{
    ...
    public FeatureQuery ToFeatureQuery(UnifiedQuery query, MetadataV2Resource resource)
    {
        ...
        var featureQuery = new FeatureQuery
        {
            ...
            GeometryType = MapV2GeometryType(resource.Spatial?.GeometryType ?? MetadataV2GeometryType.None),
    ...
    private static GeometryType MapV2GeometryType(MetadataV2GeometryType type) => type switch
    {
