...
public interface ISceneFeatureSource
{
    ...
    /// </summary>
    /// <param name="resource">Metadata v2 resource with field schema and storage binding metadata.</param>
    /// <param name="storageLayerId">Integer storage layer handle for the resource.</param>
