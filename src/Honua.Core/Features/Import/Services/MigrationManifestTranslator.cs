...
public static partial class MigrationManifestTranslator
{
    ...
    private static int? ExtractRendererCategoryCount(Dictionary<string, string> metadata, string rendererKind)
    {
    ...
    private static bool HasComplexExpression(Dictionary<string, string> metadata)
