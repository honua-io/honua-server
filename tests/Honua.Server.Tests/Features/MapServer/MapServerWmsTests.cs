...
public sealed class MapServerWmsTests : IAsyncLifetime
{
    ...
    {
        var response = await _fixture.Client.GetAsync(
            $"/rest/services/{WebAppFixture.TestServiceId}/MapServer/WMS?SERVICE=WMS&REQUEST=GetMap&BBOX=-180,-90,180,90&WIDTH=256&HEIGHT=256&CRS=EPSG:4326&FORMAT=image/png&TRANSPARENT=true");
    ...
    {
        var response = await _fixture.Client.GetAsync(
            $"/rest/services/{WebAppFixture.TestServiceId}/MapServer/WMS?SERVICE=WMS&REQUEST=GetMap&BBOX=-180,-90,180,90&WIDTH=256&HEIGHT=256&CRS=EPSG:4326&FORMAT=image/jpeg");
    ...
    public async Task Wms_GetMap_WithSrs_ReturnsImage()
    {
        ...
        var response = await _fixture.Client.GetAsync(
            $"/rest/services/{WebAppFixture.TestServiceId}/MapServer/WMS?SERVICE=WMS&REQUEST=GetMap&BBOX=-180,-90,180,90&WIDTH=256&HEIGHT=256&SRS=EPSG:4326&FORMAT=image/png");
    ...
    {
        var response = await _fixture.Client.GetAsync(
            $"/rest/services/{WebAppFixture.TestServiceId}/MapServer/WMS?SERVICE=WMS&REQUEST=GetMap&BBOX=-180,-90,180,90&WIDTH=256&HEIGHT=256&CRS=EPSG:4326&FORMAT=image/png&LAYERS={WebAppFixture.TestLayerId}");
