...
/// <summary>
/// Red probes for ArcGIS geometry and field fidelity in the migration importer.
/// These tests intentionally stay failing until the import path handles the Esri
/// payloads without dropping or changing source values.
/// </summary>
