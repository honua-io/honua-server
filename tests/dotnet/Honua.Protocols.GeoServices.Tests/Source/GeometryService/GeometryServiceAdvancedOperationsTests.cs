...
public sealed class GeometryServiceAdvancedOperationsTests : IClassFixture<WebAppFixture>
{
    private readonly WebAppFixture _fixture;

    public GeometryServiceAdvancedOperationsTests(WebAppFixture fixture)
    {
        _fixture = fixture;
    }
