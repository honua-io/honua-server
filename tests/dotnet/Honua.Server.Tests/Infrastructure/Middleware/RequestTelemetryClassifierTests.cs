...
public sealed class RequestTelemetryClassifierTests
{
    ...
    [InlineData("/rest/services/Routing/NAServer/Route/solve", HonuaTelemetry.Protocols.NAServer)]
    ...
    [InlineData("/ogc/records", HonuaTelemetry.Protocols.OgcRecords)]
    ...
    [InlineData("/rest/services/Routing/NAServer/Route/solve", "solveRoute")]
    [InlineData("/rest/services/Routing/NAServer/ServiceArea/solveServiceArea", "solveServiceArea")]
    [InlineData("/rest/services/Routing/NAServer/ClosestFacility/solveClosestFacility", "solveClosestFacility")]
