...
public sealed class GroundingServiceTests
{
    ...
    public GroundingServiceTests()
    {
        ...
        _authorizationFilter.FilterAsync(Arg.Any<ClaimsPrincipal>(), Arg.Any<IReadOnlyList<GroundingCandidate>>(), Arg.Any<CancellationToken>())
    ...
    public async Task GroundAsync_FiltersCandidatesThroughAuthorizationFilter()
    {
        ...
        _authorizationFilter.FilterAsync(Arg.Any<ClaimsPrincipal>(), Arg.Any<IReadOnlyList<GroundingCandidate>>(), Arg.Any<CancellationToken>())
            .Returns(callInfo =>
                Task.FromResult<IReadOnlyList<GroundingCandidate>>(
