...
/// <summary>
/// Collection definition for tests that run reference external server containers.
/// </summary>
[CollectionDefinition("ExternalServer", DisableParallelization = true)]
...
public sealed class ExternalServerCollection
{
