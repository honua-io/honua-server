...
public sealed class PostgresFixture : IAsyncLifetime
{
    ...
    private static readonly string[] SharedStoreMigrations =
        [
            "113_AddDurableQuerySnapshots.sql",
            "119_CreateGeoprocessingWorkspaces.sql",
            "047_CreateGdbVersions.sql",
            "121_CreateDefaultVersionIdentity.sql",
            "122_AddVersionServiceAssociation.sql"
        ];
