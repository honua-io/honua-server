...
const SRC = [
  ...
  'src/Honua.Db/Postgres.Shared/Honua.Postgres.Shared.csproj',
  'src/Honua.Db/Postgres/Honua.Postgres.csproj',
  'src/Honua.Db/MySql/Honua.MySql.csproj',
  'src/Honua.Db/Oracle/Honua.Oracle.csproj',
  'src/Honua.Db/SqlServer/Honua.SqlServer.csproj',
  'src/Honua.Db/DuckDB/Honua.DuckDB.csproj',
  ...
  'src/Honua.Cloud/Aws/Honua.Aws.csproj',
  'src/Honua.Cloud/Azure/Honua.Azure.csproj',
...
const TESTS = [
  ...
  'tests/dotnet/Honua.Db.Postgres.Security.Tests/Honua.Postgres.Security.Tests.csproj',
  'tests/dotnet/Honua.Db.MySql.Tests/Honua.MySql.Tests.csproj',
  'tests/dotnet/Honua.Db.Oracle.Tests/Honua.Oracle.Tests.csproj',
  'tests/dotnet/Honua.Db.SqlServer.Tests/Honua.SqlServer.Tests.csproj',
  'tests/dotnet/Honua.Db.DuckDB.Tests/Honua.DuckDB.Tests.csproj',
