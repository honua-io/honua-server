...
const BASE_RUNTIME_MATRIX: readonly JsRuntimeParityEntry[] = Object.freeze([
  ...
  },
  {
    ...
    honuaCompat: "compat",
    esriLeaflet: "assisted",
    notes: "goTo normalization is supported in compat runtime.",
  },
  {
    surface: "map-view",
    capability: "hit-test",
    ...
    honuaCompat: "compat",
    esriLeaflet: "assisted",
    notes: "Popup-backed hitTest helper is available in compat runtime.",
  },
  {
    surface: "map-view",
    ...
    honuaCompat: "compat",
    esriLeaflet: "assisted",
    notes: "Popup bridge helpers are available in compat runtime.",
  },
  {
    surface: "map-view",
    ...
    honuaCompat: "compat",
    esriLeaflet: "assisted",
    notes: "UI component container APIs are available in compat runtime.",
  },
  {
    surface: "map-view",
    ...
    honuaCompat: "compat",
    esriLeaflet: "assisted",
    notes: "Layer-view creation, querying, and highlight handles are compat-ready.",
  },
  {
    surface: "widget",
    ...
    honuaCompat: "compat",
    esriLeaflet: "assisted",
    notes: "Widget parity provided through compat wrappers and event bus integration.",
  },
  {
    surface: "widget",
    capability: "popup-search-and-navigation",
    arcGisJsApi: "Popup/Search/BasemapGallery/Bookmarks/Expand",
    honuaCompat: "compat",
    esriLeaflet: "assisted",
    notes: "Migration-critical widgets are compat-ready via shared event bus.",
  },
  {
    surface: "widget",
  ...
  },
  {
    ...
    honuaCompat: "compat",
    esriLeaflet: "assisted",
    notes: "Control wrappers are available and event-bus integrated in compat runtime.",
  },
]);
