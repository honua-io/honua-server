...
**Field forms** — Server-owned form packages under `/api/v1/admin/forms/packages` support draft validation, immutable publishing, reopened drafts, offline policy discovery, and JSON or multipart submissions through the shared edit and attachment pipelines.
