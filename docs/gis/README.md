...
- [Point Cloud, Drone, and Reality-Capture Ingest](point-cloud-reality-capture-ingest.md) — Spike recommendation for a pre-tiled-first ingest path with bounded follow-ups for COPC streaming and CPU/GPU PDAL conversion
...
- [Cross-Client Certification Gap Report](gap-report.md) — Latest real-client interop baseline comparison from `client-interop-nightly.yml`
