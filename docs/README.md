...
- [Disconnected Replica Conflict Review](admin-api/disconnected-replica-conflicts.md) — Named replica metadata, durable sync conflict detail, temporal-history links, and resolution APIs under `/api/v1/admin/replicas/**` (#1167).
