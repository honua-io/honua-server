...
- [Share Export and Traffic API](developer/share-export-traffic-api.md) — Scheduled Share export definitions, run history with nullable `jobRunId`, and aggregate/per-item traffic panels under `/api/v1/admin/share/**` (#1216).
