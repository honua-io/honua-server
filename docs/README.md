...
- [Temporal History API](admin-api/temporal-history.md) — Optional layer data-history endpoints for as-of reads, checkpoints, diffs, timelines, rollback planning, and job-backed corrective rollback (#1166).
