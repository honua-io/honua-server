...
- [License Migration](LICENSE_MIGRATION.md) — move from any pre-existing license format to the unified Ed25519-signed JSON envelope (ADR-0033), including startup/upload validation and bounded re-issue guidance
