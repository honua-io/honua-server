...
- [GeoServer Migration Guide](../gis/tutorials/geoserver-migration-guide.md) — Discovery scanner workflow, compatibility review, dry-run validation, and apply-plan generation
