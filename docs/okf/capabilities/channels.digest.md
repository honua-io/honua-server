...
resource: "honua://capability/channels.digest"
...
Aggregate and deliver batched alert summaries.

| | |
| --- | --- |
| Capability key | `channels.digest` |
| Category | Channels |
| Edition | Enterprise |
...
Writing the page that documents it? Declare `resource: "honua://capability/channels.digest"` in its frontmatter, or add the key under a `resources:` list if the page already claims another one, and it will be linked here.
