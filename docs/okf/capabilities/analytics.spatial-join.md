...
resource: "honua://capability/analytics.spatial-join"
...
Cross-layer spatial join with intersects/contains/within/dwithin predicates.

| | |
| --- | --- |
| Capability key | `analytics.spatial-join` |
| Category | Analytics |
| Edition | Pro |
...
Writing the page that documents it? Declare `resource: "honua://capability/analytics.spatial-join"` in its frontmatter, or add the key under a `resources:` list if the page already claims another one, and it will be linked here.
