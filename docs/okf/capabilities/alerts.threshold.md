...
resource: "honua://capability/alerts.threshold"
tags: [capability, alerts, enterprise]
---
<!-- GENERATED FILE - DO NOT EDIT. Regenerate with scripts/ci/generate-capability-concepts.py -->

# Threshold Trigger

Trigger alerts based on attribute threshold conditions.

| | |
| --- | --- |
| Capability key | `alerts.threshold` |
| Category | Alerts |
| Edition | Enterprise |
