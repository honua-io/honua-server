...
Read and query collections/items through OGC API - Features. Mutation is Community via the shared edit pipeline (distinct from the Pro FeatureServer write gate).

| | |
| --- | --- |
| Capability key | `serve.ogc-api-features` |
| Category | Serve |
| Edition | Community |
