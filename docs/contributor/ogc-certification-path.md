...
| WFS 2.0 | Service-level CITE | `ogccite/ets-wfs20:latest`; generated TeamEngine params use `ets-wfs20-1.43`; scheduled profile `basic`; on-demand classic wrapper can run WFS 2.0 | `scripts/conformance/cite/run-cite-wfs20-tests.sh`; `.github/workflows/cite-wfs20-conformance.yml`; on-demand wrapper `.github/workflows/cite-classic-conformance.yml` | Latest: [Run 24978795599](https://github.com/honua-io/honua-server/actions/runs/24978795599), 2026-04-27, `trunk`, SHA `d38db2796319c91018a8c43e1014257525306c4f`; artifact `wfs20-cite-results-basic-22`; summary `cite-summary.md`. Earlier retained run: [24650295507](https://github.com/honua-io/honua-server/actions/runs/24650295507), artifact `wfs20-cite-results-basic-21` | PARTIAL/latest workflow failure: latest summary reports 240 total, 174 passed, 66 failed, 72% success. Earlier retained run reports PARTIAL, 240 total, 182 passed, 58 failed | Not certification-ready. Resolve Basic profile failures, stop treating workflow conclusion alone as evidence, and preserve a clean CITE summary before considering WFS. |
...
| WMTS 1.0 | Service-level CITE | `ogccite/ets-wmts10:1.11-teamengine-6.0.0-RC2`; workflow profile `default` | `scripts/conformance/cite/run-cite-wmts-tests.sh`; `.github/workflows/cite-wmts-conformance.yml` | Latest: [Run 24824149578](https://github.com/honua-io/honua-server/actions/runs/24824149578), 2026-04-23, `trunk`, SHA `93ada0a560272790fe4127f5a273192d17220144`; artifact `cite-wmts-conformance-results-56`; summary `cite-wmts-results/cite-wmts-summary.md`. Earlier passing retained run: [24498936417](https://github.com/honua-io/honua-server/actions/runs/24498936417), artifact `cite-wmts-conformance-results-55` | FAIL/latest: 60 total, 56 passed, 4 failed. Earlier retained run passed 60/60 on 2026-04-16 | Not certification-ready until the latest scheduled lane is restored to a clean pass and rerun against the release candidate. |
