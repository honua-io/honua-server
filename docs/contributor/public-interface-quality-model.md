...
| `#467` | The OData client suite already exists. Remaining work is keeping release evidence links current. | [`ODataClientIntegrationTests.cs`](../../tests/dotnet/Honua.Server.Tests/Features/OData/ODataClientIntegrationTests.cs) |
