...
| Consumer ↓ \ Provider → | Abstr | Core | Geo | Gcod | Aws | Azure | Hosting | Jobs | Ai | Gproc | Io | Postgres | DuckDB | MySql | SqlServer | Protocols.X | Server | SvcDef |
|--------------------------|:-----:|:----:|:---:|:----:|:---:|:-----:|:-------:|:----:|:--:|:-----:|:---:|:--------:|:------:|:-----:|:---------:|:-----------:|:------:|:------:|
| **Abstractions**         |       |      |     |      |     |       |         |      |    |       |       |          |        |       |           |             |        |        |
| **Core**                 |   ✓   |      |     |      |     |       |         |      |    |       |       |          |        |       |           |             |        |        |
| **Geometry**             |   ✓   |  ✓   |     |      |     |       |         |      |    |       |       |          |        |       |           |             |        |        |
