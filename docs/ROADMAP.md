...
This roadmap assumes the MVP described in `docs/MVP_PLAN.md`. The current repo already ships the core server APIs (FeatureServer, OGC API Features/Tiles, OData v4, file import, admin APIs), but MVP items like admin UI, TileJSON, service enable/disable, and deployment templates are still pending. Track open MVP issues (#20, #25, #26, #27, #30, #31, #32, #33, #34, #38, #39, #42, #43, #58, #187).
