...
- [Console Open-Data Publication API](../contributor/open-data-publication-api.md) — Open-data page state, anonymous `/open-data` reads, DCAT/data.json validation/export, Schema.org preview, and Console STAC publication controls for Console Share
