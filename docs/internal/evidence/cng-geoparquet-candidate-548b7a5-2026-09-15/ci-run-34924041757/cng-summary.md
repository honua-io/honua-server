...
**Execution Date**: Tue Sep 15 03:19:06 UTC 2026
**Honua Server Version**: f820af6
...
|---|---|---|---|---|
| GeoParquet 1.1.0 | FeatureServer `f=parquet` | `gpq validate` | FAIL | gpq validate reported non-conformant GeoParquet |
