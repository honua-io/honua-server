...
[MCP_SERVER.md](../../guides/connect/ai-agents-mcp.md) and the canonical implementation of the
...
in [MCP_SERVER.md](../../guides/connect/ai-agents-mcp.md#payload-notes); the domain types they map
