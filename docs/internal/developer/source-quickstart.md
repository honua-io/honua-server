...
[Windows: install published packages](../../get-started/windows-packages.md). That journey needs
...
- [Publish your first dataset](../../get-started/first-dataset.md) — the import → publish → query flow in detail
- [Make your first map](../../get-started/first-map.md) — TileJSON, auto-generated styles, and MapLibre
