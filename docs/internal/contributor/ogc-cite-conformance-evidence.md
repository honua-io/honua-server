...
completed on 2026-09-02 against candidate commit
`a59e204c75a1b51a433faf45d7511c10840786d7`. It reports 167 passed, 0 failed,
and 0 skipped. The remaining suites use the
...
and 0 CantTell across 14 suites. Treat the newer per-suite WFS run as
authoritative where the receipts differ.
