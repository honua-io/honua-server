...
|---|---|---|---|---|---|
| `Microsoft.OData.Client` integration suite | `odata-v4` | Keep the exact package version pinned in [`Directory.Packages.props`](../../../Directory.Packages.props) and the package reference in [`Honua.Protocols.OData.Tests.csproj`](../../../tests/dotnet/Honua.Protocols.OData.Tests/Honua.Protocols.OData.Tests.csproj); mention that version in release notes for the OData lane. | [`ODataClientIntegrationTests.cs`](../../../tests/dotnet/Honua.Protocols.OData.Tests/Source/ODataClientIntegrationTests.cs) and the `all-test-results` artifact in [`ci.yml`](../../../.github/workflows/ci.yml) | `honua-server` | implemented |
...
| `#467` | The OData client suite already exists. Remaining work is keeping release evidence links current. | [`ODataClientIntegrationTests.cs`](../../../tests/dotnet/Honua.Protocols.OData.Tests/Source/ODataClientIntegrationTests.cs) |
