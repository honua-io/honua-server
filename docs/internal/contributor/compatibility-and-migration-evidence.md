...
|---|---|---|---|
| OGC CITE standards compliance | Passing current trunk evidence | [OGC CITE Conformance Evidence](ogc-cite-conformance-evidence.md); latest aggregate artifact: [33205558805](https://github.com/honua-io/honua-server/actions/runs/33205558805), 1138 passed, 0 failed, 0 skipped, 0 CantTell (the workflow attempt itself failed its final checked-in-snapshot freshness check) | None for the listed public CITE suite set. |
