...
| Operator review and cutover workbench | Not complete | Stable artifact contracts can be displayed by downstream UI | Track review, approvals, parity evidence, redaction, retries, exports, and cutover readiness in the active [honua-console](https://github.com/honua-io/honua-console) repository. |
