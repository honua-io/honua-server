...
| [ImageServer](#imageserver) | Partial | Service metadata, exportImage, identify, tile, catalog query, find, measure (Basic), statistics/histograms, getSamples, queryBoundary, computePixelLocation, project, storage-backed exportTiles, dynamic computeCacheInfo, legend, WCS 2.0.1 KVP | Catalog mutation, full Esri tile-package/job export semantics, sensor/DEM height mensuration, generated ImageServer tile caches, camera/orientation-ranked find, renderingRule execution, AOI clipping for stats, WMTS |
