...
| createReplica, extractChanges, synchronizeReplica, unRegisterReplica | Preview | Offline sync is Preview in 2026.1 per the OPERATOR RULING 2026-09-03. Security and replica-isolation hardening ships in 2026.1; the remaining Esri payload, cursor, ID, paging, geometry, and transport parity gaps are deferred to release/2026.2. |
