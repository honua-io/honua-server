...
| [ImageServer](#imageserver) | Partial | Service metadata, exportImage, identify, tile, catalog query, statistics/histograms, getSamples, queryBoundary, computePixelLocation, project, dynamic computeCacheInfo, legend, WCS 2.0.1 KVP | Catalog mutation, export tiles, measure, generated ImageServer tile caches, renderingRule execution, AOI clipping for stats, WMTS |
...
| addRasters, deleteRasters, updateRaster, uploads, downloadRasters, exportTiles, find, measure, calculateVolume, computeMultidimensionalInfo, computeTiePoints, validate | Not implemented | Raster ingestion happens through the Honua admin API (`/api/v1/admin/import/raster`, `/api/v1/admin/cloud-rasters`) instead. |
