...
| [MapServer](#mapserver--wms--wmts) | Partial | Export, identify, find, legend/queryLegends, query, mapLayer dynamicLayer metadata, tiles with cloud-storage cache, storage-backed exportTiles, generateKml, WMS 1.3/1.1.1, WMTS 1.0 | Full Esri tile-package/job export semantics, workspace dynamic layers/tables, several child resources; WMTS serves WebMercatorQuad and WorldCRS84Quad gridsets |
