...
| `raster.interpolate-kriging` | **UNAVAILABLE** — no kriging backend in the worker image; direct submission is rejected with a clear reason. Use `raster.interpolate-idw`. | `points`, `zField` |
