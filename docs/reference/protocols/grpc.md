...
[`public-interface-quality-model.md`](../../internal/contributor/public-interface-quality-model.md)
...
5. **Hold the deprecation window.** `v1` must remain wire-compatible and
   ...
   [tool lanes](../../internal/contributor/public-interface-quality-model.md#tool-lanes))
