...
- OGC API Features, Tiles, Maps, Coverages, Processes, WFS 2.0, WMS 1.3, WMTS 1.0, WCS 2.0.1, OData v4, STAC catalog/search/items, open-data page/DCAT catalog reads, COG registration, vector tiles, Terrain-RGB tiles, and elevation value/profile APIs.
...
- Open-data publication: `src/Honua.Server/Features/Infrastructure/OpenData/`, `src/Honua.Server/Features/Protocols/OpenData/`
