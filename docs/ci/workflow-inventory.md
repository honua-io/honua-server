...
| `windows-client-compat-nightly.yml` | Windows Client Compatibility Certification | nightly | `schedule`, `workflow_dispatch` | No | Daily 7:15am UTC; emits canonical `artifacts/client-compat/<service>-<timestamp>/` evidence |
