...
See [MCP Certification](../../internal/contributor/mcp-certification.md) for contributor guidance on seed data, CI jobs, and test structure.
...
[GROUNDING.md](../../internal/developer/GROUNDING.md) for the full pipeline.
...
- `honua_validate_package` and `honua_preview_package` accept the shared
  ...
  [Package Review API](../../internal/developer/package-review-api.md). Both tools return the canonical
...
- `honua_clarify_intent` accepts the same shape plus a required
  ...
  [GROUNDING.md](../../internal/developer/GROUNDING.md) for the material-ambiguity rule set and
...
[Control Plane API](../../reference/admin-api/overview.md#analysis-report-endpoints)
