...
[ADR-0029](../../internal/contributor/adr/0029-geoprocess-canonical-model-mappings.md).
...
See [OGC API Processes Coverage](../../reference/protocols/specifications/ogc-api-processes-coverage.md) for endpoint and conformance details.
...
See [ADR-0032](../../internal/contributor/adr/0032-workflow-orchestration-layer.md) for
design rationale and [Operations — Workflow Orchestration](../deploy/operations.md)
...
- [ADR-0026: AI-First Operator Contract](../../internal/contributor/adr/0026-ai-first-operator-contract.md)
