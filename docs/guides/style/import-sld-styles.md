...
This reference catalogs the supported SLD subset, the diagnostic taxonomy, the security stance, and the known limitations callers must plan for. It complements [GeoServer to Honua Migration Guide](../migrate/from-geoserver.md).
...
- [GeoServer to Honua Migration Guide](../migrate/from-geoserver.md)
