...
[Point Cloud, Drone, and Reality-Capture Ingest](../../internal/spikes/point-cloud-reality-capture-ingest.md)
(`honua-server-900`); and the Pro-gated OpenUSD preview surface emits a
metadata-only USDA stage manifest as documented in
[OpenUSD and Omniverse Export Path](../../internal/spikes/openusd-omniverse-export-path.md)
...
Scenes are registered through the [scene dataset registry admin API](../../internal/admin-api/scene-dataset-registry.md)
...
[NVIDIA construction demo fixture](../../internal/demo/nvidia-construction.md) is a
...
Datasets registered through the [scene dataset registry](../../internal/admin-api/scene-dataset-registry.md)
