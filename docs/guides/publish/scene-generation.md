...
served through the existing hosted scene infrastructure ([scenes-3dtiles](publish-3d-scenes.md)).
...
authoritative ([scene-dataset-registry.md](../../internal/admin-api/scene-dataset-registry.md)).
...
- [Hosted 3D Tiles serving](publish-3d-scenes.md) (#837)
- [Scene dataset registry admin API](../../internal/admin-api/scene-dataset-registry.md) (#844)
- [Extruded 3D feature layers](extruded-3d-feature-layers.md) (#841)
- [Point cloud, drone, and reality-capture ingest](../../internal/spikes/point-cloud-reality-capture-ingest.md) (#900) — spike recommendation that complements this generation pipeline by registering pre-tiled drone/scanner output through the same scene dataset registry.
