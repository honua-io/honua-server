...
end-to-end operator eval harness (`tests/dotnet/Honua.TestKit/Eval/` plus scenarios
in `tests/dotnet/eval/scenarios/`). Each scenario captures `AnalysisIntent`, compiles
