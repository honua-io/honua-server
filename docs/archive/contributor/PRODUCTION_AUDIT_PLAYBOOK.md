...
- Run [Client Templates + Manual Smoke Runbook](../../gis/CLIENT_TEMPLATE_RUNBOOK.md) and update [Client Template Version Matrix](../../gis/CLIENT_TEMPLATE_VERSION_MATRIX.md)
