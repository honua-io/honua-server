...
- `honua-io/honua-server#735`
  - read `src/Honua.Server/Features/GeometryService/GeometryServiceEndpoints.cs`, `src/Honua.Server/Features/GeometryService/Services/GeometryServiceHandler.cs`, `src/Honua.Server/Features/SpatialAnalytics/SpatialAnalyticsEndpoints.cs`, `src/Honua.Server/Features/SpatialAnalytics/SpatialAnalyticsRequestHandlers.BufferAggregate.cs`, `src/Honua.Server/Features/SpatialAnalytics/SpatialAnalyticsRequestHandlers.SpatialJoin.cs`, `tests/dotnet/Honua.Server.Tests/Features/GeometryService/GeometryServiceBufferTests.cs`, and `tests/dotnet/Honua.Server.Tests/Features/SpatialAnalytics/SpatialAnalyticsRestTests.cs`
