...
Workspace and retention configuration is shared with the canonical geoprocessing runtime under `Geoprocessing:Workspace`. See [Backup and restore](../../guides/deploy/backup-and-restore.md) for operational lifecycle guidance.
